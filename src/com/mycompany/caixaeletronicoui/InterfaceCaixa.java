...
public class InterfaceCaixa extends javax.swing.JFrame {
    ...
    private void btnDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepositoActionPerformed
        ...
        if(valorDeposito <= 0){
            JOptionPane.showMessageDialog(null, "DIGITE UM VALOR MAIOR QUE 0!!" + JOptionPane.ERROR_MESSAGE);
        }else{
    ...
    private void btnSaqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaqueActionPerformed
        ...
        if(valorSaque >= objConta.saldo){
            JOptionPane.showMessageDialog(null, "DIGITE UM VALOR INFERIOR AO SALDO ATUAL!!" + JOptionPane.ERROR_MESSAGE);
        }else{
